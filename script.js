...
// COMPLETE WITH VERIFIED WORKING CREDENTIALS
...
const MPESA_CONFIG = {
    ...
    // Passkey from successful test (VERIFIED WORKING)
    passkey: 'MTc0Mzc5YmZiMjc5ZjlhYTliZGJjZjE1OGU5N2RkNzFhNDY3Y2QyZTBjODkzMDU5YjEwZjc4ZTZiNzJhZGExZWQyYzkxOTIwMjYwMzE4MDAzNDE2',
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (orderForm) {
        orderForm.addEventListener('submit', async function(e) {
            ...
            // Get amount from budget slider or package price
